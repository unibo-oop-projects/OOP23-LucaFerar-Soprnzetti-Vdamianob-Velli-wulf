...
public class MapFactoryImpl implements MapFactory{
    ...
    public Map getDefaultMap1() {
        ...
        thirdBiome.addCorridor(new TilePosition(7, 4), new Corridor(6, 2));
        thirdBiome.addCorridor(new TilePosition(10, 6), new Corridor(2, 6));
        thirdBiome.addCorridor(new TilePosition(14, 10), new Corridor(2, 4));
        thirdBiome.addCorridor(new TilePosition(14, 10), new Corridor(2, 4));
        thirdBiome.addCorridor(new TilePosition(12, 10), new Corridor(2, 2));
